...
public class Place implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "place_place_att",
               joinColumns = @JoinColumn(name = "place_id", referencedColumnName = "id"),
               inverseJoinColumns = @JoinColumn(name = "place_att_id", referencedColumnName = "id"))
    private Set<Attribute> placeAtts = new HashSet<>();
    ...
    public Place placeTypes(Set<PlaceType> placeTypes) {
        this.placeTypes = placeTypes;
        return this;
    }

    public Place addPlaceType(PlaceType placeType) {
        this.placeTypes.add(placeType);
        placeType.setPlace(this);
        return this;
    }

    public Place removePlaceType(PlaceType placeType) {
        this.placeTypes.remove(placeType);
    ...
    public Set<Attribute> getPlaceAtts() {
        return placeAtts;
    }

    public Place placeAtts(Set<Attribute> attributes) {
        this.placeAtts = attributes;
        return this;
    }

    public Place addPlaceAtt(Attribute attribute) {
        this.placeAtts.add(attribute);
        attribute.getAttributes().add(this);
        return this;
    }

    public Place removePlaceAtt(Attribute attribute) {
        this.placeAtts.remove(attribute);
        attribute.getAttributes().remove(this);
        return this;
    }

    public void setPlaceAtts(Set<Attribute> attributes) {
        this.placeAtts = attributes;
    }
