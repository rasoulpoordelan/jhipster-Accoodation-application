...
import { PlaceMySuffixComponent } from 'app/entities/place-my-suffix/place-my-suffix.component';
...
describe('Component Tests', () => {
  describe('PlaceMySuffix Management Component', () => {
    let comp: PlaceMySuffixComponent;
    let fixture: ComponentFixture<PlaceMySuffixComponent>;
    let service: PlaceMySuffixService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [JhipsterAccApplicationTestModule],
        declarations: [PlaceMySuffixComponent],
        providers: [
          {
        ...
        .overrideTemplate(PlaceMySuffixComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PlaceMySuffixComponent);
