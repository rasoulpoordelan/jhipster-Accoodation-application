...
describe('Service Tests', () => {
  describe('TagMySuffix Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new TagMySuffix(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a TagMySuffix', async () => {
      ...
      it('should update a TagMySuffix', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB'
          },
      ...
      it('should return a list of TagMySuffix', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB'
          },
      ...
      it('should delete a TagMySuffix', async () => {
